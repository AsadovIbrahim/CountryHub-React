  ...
  return client$$1.before().reduce(function (previous, current) {
    return previous.then(function () {
      ...
      return new Promise(function (resolve, reject) {
        var mergedData = deepmerge.all([requestData, response]);
...
var getHTTPMethods = function getHTTPMethods(client$$1) {
  ...
  return {
    post: function post(uri) {
      ...
      return clientRequest('POST')(uri, deepmerge(options, { body: JSON.stringify(data) }));
    },
    ...
    patch: function patch(uri) {
      var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return clientRequest('PATCH')(uri, deepmerge(options, { body: JSON.stringify(data) }));
    },
    put: function put(uri) {
      var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return clientRequest('PUT')(uri, deepmerge(options, { body: JSON.stringify(data) }));
    },
    delete: function _delete(uri) {
      var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      return clientRequest('DELETE')(uri, deepmerge(options, { body: JSON.stringify(data) }));
    }
  };
};
